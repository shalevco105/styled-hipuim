...
export default function WhatsAppButton() {
    return (
        ...
        >
            ...
            {/* Button */}
            <span className="relative flex items-center justify-center w-16 h-16 rounded-full bg-[#1a1a1a] shadow-2xl hover:scale-110 transition-transform duration-200 border-2 border-[#25D366]/40">
                <WhatsAppSVG />
            </span>
